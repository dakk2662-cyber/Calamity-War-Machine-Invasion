using CalamityAddon.Content.Items.Placeables;
...
namespace CalamityAddon.Content.Tiles
{
    public class MechanismWarfareMusicBoxTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<MechanismWarfareMusicBox>();
        }
